...
//									CONFIGURATION BITS
//*****************************************************************************************************************
#pragma	config	POSCMOD=HS,FCKSM=CSDCMD,IESO=ON
#pragma	config	FWDTEN=ON,DSBOREN=OFF
#pragma	config	DSWDTOSC=LPRC
/*#pragma	config	MCLRE=ON,PBAD=DIG,CCP2MX=C1*/
//#pragma	config	STVR=ONLVP=OFF,DEBUG=OFF
...
#pragma config WPDIS=WPEN,WPCFG=WPCFGEN
//*****************************************************************************************************************
//							   			VECTORS REMAPING											                         */
//*****************************************************************************************************************
//#ifdef BOOTLOADER
...
{
//IO setting-up
	AD1CON1=0b00001111; //initially ADCON1 ?		 //All chanels are digital I/O
